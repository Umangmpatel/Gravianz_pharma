    ...
    <AuthContainer>
      <View style={styles.containerStyle}>
        ...
        <CTTextInput
          ...
          onSubmitEditing={() => setTimeout(() => contactNumberRef.current.focus(), 500)}
          returnKeyType="next"
        />
        <CTSpacer height={30} />
        ...
        <CTTextInput
          ...
          maxLength={10}
          onSubmitEditing={() => setTimeout(() => stateRef.current.focus(), 500)}
          returnKeyType="next"
        />
        <CTSpacer height={30} />
        ...
        <CTTextInput
          ...
          errorMsg={areaError}
          onSubmitEditing={() => setTimeout(() => emailRef.current.focus(), 500)}
          returnKeyType="next"
        />
        <CTSpacer height={30} />
        ...
        <CTTextInput
          ...
          onSubmitEditing={() => setTimeout(() => passwordRef.current.focus(), 500)}
          returnKeyType="next"
        />
        <CTSpacer height={30} />
        ...
        <CTTextInput
          ...
          onSubmitEditing={() => setTimeout(() => confirmPasswordRef.current.focus(), 500)}
          returnKeyType="next"
        />
        <CTSpacer height={30} />
